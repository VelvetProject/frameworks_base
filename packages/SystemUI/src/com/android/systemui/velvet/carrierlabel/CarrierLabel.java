...
package com.android.systemui.velvet.carrierlabel;
...
import com.android.internal.util.velvet.VelvetUtils;
...
import com.android.systemui.velvet.carrierlabel.SpnOverride;
    ...
    private final BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (TelephonyIntents.SPN_STRINGS_UPDATED_ACTION.equals(action)
                ...
                isCN = VelvetUtils.isChineseLanguage();
            }
        }
    };
